...
class Blinc extends React.Component {
    ...
    render() {
        return (
            <BodyClassName className="blincTheme">
                <Basic history={this.props.history} theme="blincTheme" colorPalette={this.colorPalette} themeName={"Light"}/>
            </BodyClassName>
        );
    }
